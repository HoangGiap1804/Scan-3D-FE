...
const Features = () => {
    ...
    const features = [
        {
            ...
            description: 'Experience latency-free communication with our optimized websocket infrastructure.',
            details: [
        ...
        },
        {
            ...
            description: 'Your messages and data are protected with military-grade end-to-end encryption.',
            details: [
                'AES-256 encryption',
        ...
        },
        {
            ...
            description: 'Share your ideas visually with integrated whiteboarding and asset sharing tools.',
            details: [
                'Interactive whiteboards',
                'Drag-and-drop file sharing',
                'Version control for assets'
            ],
            image: 'https://images.unsplash.com/photo-1560419015-7c427e8 ae5ba?auto=format&fit=crop&q=80&w=800'
        },
        {
            icon: '🤖',
            title: 'AI Assisted',
            description: 'Let our AI helpers manage your schedule, summarize threads, and draft responses.',
            details: [
                'Smart auto-reply',
                'Meeting summaries',
    ...
    return (
        <section id='features' className='py-24 bg-transparent backdrop-blur-[2px] relative'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className='text-center max-w-3xl mx-auto mb-12'>
                    <h2 className='text-blue-400 font-semibold tracking-wide uppercase text-sm mb-3'>Features</h2>
                    <h3 className='text-3xl md:text-5xl font-bold text-white mb-6'>Everything you need to collaborate</h3>
                </div>
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-16">
                    {features.map((feature, index) => (
                        <button
                            ...
                            className={`flex items-center space-x-2 px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 ${activeTab === index
